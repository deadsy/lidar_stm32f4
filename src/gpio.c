...
static const GPIO_INFO gpio_info[] = {
    ...
    // serial port (usart1 function)
    {UART_TX, GPIO_MODE_AF_PP, GPIO_NOPULL, GPIO_SPEED_HIGH, GPIO_AF7_USART1, -1},
    {UART_RX, GPIO_MODE_AF_PP, GPIO_NOPULL, GPIO_SPEED_HIGH, GPIO_AF7_USART1, -1},

    // pwm motor control (TIM2 channel 1)
    {LIDAR_PWM, GPIO_MODE_AF_PP, GPIO_NOPULL, GPIO_SPEED_HIGH, GPIO_AF1_TIM2, -1},
